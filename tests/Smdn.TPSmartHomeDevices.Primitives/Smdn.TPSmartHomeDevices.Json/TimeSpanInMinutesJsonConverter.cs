...
public class TimeSpanInMinutesJsonConverterTests {
  private static System.Collections.IEnumerable YieldTestCases_Read()
  {
    ...
    yield return new object?[] { /*lang=json,strict*/ @"{""time_diff"": null}", null }; // invalid
    yield return new object?[] { /*lang=json,strict*/ @"{""time_diff"": ""invalid""}", null }; // invalid
  ...
  {
    yield return new object?[] { null, /*lang=json,strict*/ @"{""time_diff"":null}", null };
    yield return new object?[] { TimeSpan.Zero, /*lang=json,strict*/ @"{""time_diff"":0}", typeof(NotImplementedException) };
    yield return new object?[] { TimeSpan.FromHours(+9.0), /*lang=json,strict*/ @"{""time_diff"":540}", typeof(NotImplementedException) };
    yield return new object?[] { TimeSpan.FromHours(-5.0), /*lang=json,strict*/ @"{""time_diff"":-300}", typeof(NotImplementedException) };
  }
