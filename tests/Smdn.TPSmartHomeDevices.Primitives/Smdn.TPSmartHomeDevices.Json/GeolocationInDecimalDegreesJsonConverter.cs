...
public class GeolocationInDecimalDegreesJsonConverterTests {
  private static System.Collections.IEnumerable YieldTestCases_Read()
  {
    ...
    yield return new object?[] { /*lang=json,strict*/ @"{""longitude"": null}", null }; // invalid
    yield return new object?[] { /*lang=json,strict*/ @"{""longitude"": ""invalid""}", null }; // invalid
    yield return new object?[] { /*lang=json,strict*/ @"{""longitude"": ""0""}", null }; // invalid
    yield return new object?[] { /*lang=json,strict*/ @"{""longitude"": 0}", 0.0m };
    yield return new object?[] { /*lang=json,strict*/ @"{""longitude"": 1}", 0.0001m };
    yield return new object?[] { /*lang=json,strict*/ @"{""longitude"": -1}", -0.0001m };
    yield return new object?[] { /*lang=json,strict*/ @"{""longitude"": 12345}", 1.2345m };
    yield return new object?[] { /*lang=json,strict*/ @"{""longitude"": 12345.6}", 1.23456m };
    yield return new object?[] { /*lang=json,strict*/ @"{""longitude"": 67890}", 6.789m };
  }
  ...
  {
    yield return new object?[] { null, /*lang=json,strict*/ @"{""longitude"":null}", null };
    yield return new object?[] { 0.0m, /*lang=json,strict*/ @"{""longitude"":0}", typeof(NotImplementedException) };
    yield return new object?[] { 0.1m, /*lang=json,strict*/ @"{""longitude"":0.1}", typeof(NotImplementedException) };
    yield return new object?[] { -1m, /*lang=json,strict*/ @"{""longitude"":-11}", typeof(NotImplementedException) };
    yield return new object?[] { 12345m, /*lang=json,strict*/ @"{""longitude"":12345}", typeof(NotImplementedException) };
  }
